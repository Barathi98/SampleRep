...
//   		   System.out.println("Not updated");
//      }
       StudentEntityExample getcall=session.get(StudentEntityExample.class, 101);
       System.out.println(getcall);
       StudentEntityExample getcall2=session.get(StudentEntityExample.class, 101);
       ...
       StudentEntityExample getcall21=session2.get(StudentEntityExample.class, 101);
       System.out.println(getcall21);
       session2.close();
